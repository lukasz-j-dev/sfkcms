...
if(!empty($_REQUEST['violation_id'])){
	...
	*, *:before, *:after {
	...
	if(count($violations_details) > 0){
		...
		foreach($violations_details as $violation_details){
			...
			$html .= '
				<div class="header">
							<div class="row">
									<div class="col-md-12 logoimg"><div style="height: 0; text-align: left;"><img class="logo" src="../cms/public/images/villages/' . $violation_details['village_logo'] . '" style="padding-left:5px;"></div>
										<div>
	...
	//echo $html;
	//exit;
	$filename = 'Violation-' . $violation_details['camera_zip'] . '-'. $violation_details['violation_number'] . '-' . $violation_details['pin'];
