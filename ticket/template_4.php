		...
		<div class="row">
			...
			<div class="you-must-pay">
				...
				<div class="finedate" >
						...
						<p class="date-main"><span class="mn_fine_amount">$' . $violation_details['fine_amount'] . '</span></p>
		...
		<div class="row">
			...
			<div class="col-md-4 points-to-assess padding-0 ">
				...
				<div class="scan_qr">
					...
					<p class="qr_text">Scan QR code to view warning.</p>
