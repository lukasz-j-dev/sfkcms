		...
		<div class="header">
					...
					<table style="width: 100%;">
						<tr>
							<td style="width:60%;">
								<div class="logoimg">
									<img class="logo" src="../cms/public/images/villages/' . $violation_details['village_logo'] . '" style="padding-left:5px;max-width: 120px; max-height: 100px;">
		...
		<div class="row">
			...
			<div class="you-must-pay">
				<div class="finedate" >
						...
						$' . $violation_details['fine_amount'] . '</p>
		...
		<div class="header">
					...
					<table style="width: 100%;">
						<tr>
							<td style="width:60%;">
								<div class="logoimg">
									<img class="logo" src="../cms/public/images/villages/' . $violation_details['village_logo'] . '" style="padding-left:5px;max-width: 120px;">
									<div style="position: relative;top: 23px;">
										<p class="village-of-great-neck">' . $violation_details['village_court_text'] . '</p>
	...
	<table class="violation-info-table">
		...
		<tbody>
			...
			<tr>
				...
				<td>' . $violation_details['type'] . '</td>

				<td>' . $violation_date . '<br>' . $violation_details['violation_time'] . '</td>

				<td>STOP SIGN</td>

				<td style="text-transform: uppercase;">' . $violation_details['camera_location'] . '-' . $violation_details['camera_zip'] . '</td>
