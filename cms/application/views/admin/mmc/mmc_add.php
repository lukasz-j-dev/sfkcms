                ...
                <div class="row clearfix">
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-8 col-md-10 col-sm-8 col-xs-7">
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" id="plate_region" name="plate_region" class="form-control">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-8 col-md-10 col-sm-8 col-xs-7">
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" id="plate_coordinates" name="plate_coordinates" class="form-control">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-8 col-md-10 col-sm-8 col-xs-7">
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" id="plate_score" name="plate_score" class="form-control">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-8 col-md-10 col-sm-8 col-xs-7">
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" id="vehicle_orientation" name="vehicle_orientation" class="form-control">
                                </div>
                            </div>
                        </div>
                    </div>
