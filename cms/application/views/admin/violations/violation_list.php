	  ...
	  var table = $('#na_datatable').DataTable( {
		  ...
		  "aoColumnDefs": [
			...
			{ "aTargets": [5], "sName": "violation_date", 'bSearchable':true, 'bSortable':true, 'iDataSort': 5},
				{ "aTargets": [6], "sName": "violation_date_new", 'bSearchable':true, 'bSortable':true, 'iDataSort': 6},
			
			{ "aTargets": [7], "sName": "notice_date", 'bSearchable':false, 'bSortable':true, 'iDataSort': 7},
				{ "aTargets": [8], "sName": "notice_date_new", 'bSearchable':false, 'bSortable':true},

			{ "aTargets": [9], "sName": "due_date", 'bSearchable':true, 'bSortable':true, 'iDataSort': 8},
			
			{ "aTargets": [10], "sName": "due_date_new", 'bSearchable':true, 'bSortable':true},
			...
			{ "aTargets": [15], "sName": "violation_date_stamp", bVisible: false, 'bSortable':true},
			
			{ "aTargets": [16], "sName": "due_date_stamp", bVisible: false, 'bSortable':true},
			
			{ "aTargets": [17], "sName": "full_name", bVisible: false, 'bSearchable':true, 'bSortable':true},
			
			{ "aTargets": [18], "sName": "address1", bVisible: false, 'bSearchable':true, 'bSortable':true},
			
			{ "aTargets": [19], "sName": "address2", bVisible: false, 'bSearchable':true, 'bSortable':true},
			
			{ "aTargets": [20], "sName": "zip", bVisible: false, 'bSearchable':true, 'bSortable':true},
